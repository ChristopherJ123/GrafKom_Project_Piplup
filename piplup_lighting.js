    ...
    generateBeak: function(width, thickness, length, segments, color) {
        ...
        for (let i = 1; i <= segments; i++) {
            ...
            for (let j = 0; j < segments; j++) {
                ...
                const normal = [x, y, 0];
                vertices.push(x, y, currentZ, color[0], color[1], color[2], t, j / segments, normal[0], normal[1], normal[2]);
            }
        }
    ...
    generateTubeFromSpline: function(controlPoints, segments, radius, radialSegments, color) {
        ...
        for (var i = 0; i < splinePoints.length; i++) {
            ...
            for (var j = 0; j <= radialSegments; j++) {
                ...
                // Color
                vertices.push(color[0], color[1], color[2], j / radialSegments, i / splinePoints.length, n[0],n[1],n[2]);
            }
        }
